...
def generate_launch_description():
    ...
    run_nodes = TimerAction(
        ...
        actions=[
            ...
            ExecuteProcess(cmd=['tmux', 'new-window', '-t', tmux_session_name, '-n', 'mqtt']),
            ExecuteProcess(cmd=['tmux', 'send-keys', '-t', f'{tmux_session_name}:mqtt', 
                 f'ros2 run localisation_engine mqtt_publisher_node --ros-args --params-file {config_file_path}', 'C-m']),
